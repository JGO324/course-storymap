...
var options = {
  ...
  /* OUTPUT THE RESULT OF THE ABOVE ARRAYS */
//   console.log(cities), //output the result cities in the console.
//     console.log(cityPops), //output the result cityPops in the console
//     console.log(cityCoords), //output the result cityCoords in the console
//     console.log(cityCapital), //output the result cityCapital in the console
//     console.log(cityStates); //output the result cityCoords in the console
//   console.log(cityLinks) //output the result cityLinks in the console
//   console.log(cityImages) //output the result cityImages in the console
  ...
  for (var i = 0; i < cities.length; i++) {
    ...
    // imgPopupHighlight.appendChild(infoContainer);
    // console.log(imgPopupHighlight);

    L.marker(cityCoords[i]).addTo(map) // add it to the map
